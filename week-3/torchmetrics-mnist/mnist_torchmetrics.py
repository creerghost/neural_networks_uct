...
# TODO: Instead of using a manually coded accuracy metric, create an instance of the selected metric from
#  the torchmetrics package and use it to update and compute the metric appropriately for the train, dev, and test datasets.
...
def main(args):
    ...
    # TODO: Create an instance of torchmetrics Accuracy for the "multiclass" task, or use the MulticlassAccuracy metric from torchmetrics.
    #       For the MulticlassAccuracy instance, set the averaging to "micro" to average over all samples.
    ...
    # Transfer the constructed metric object to the target device so that state variables are computed and stored on that device.
    ...
    for epoch in range(args.epochs):
        ...
        # TODO: Compute the final metric value and transfer it to the CPU.
