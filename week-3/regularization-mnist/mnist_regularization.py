...
parser.add_argument("--no_dataset_restriction", help='Train on the full dataset.', action='store_true')
...
def main(args):
    ...
    # Load data
    if args.no_dataset_restriction:
        mnist = MNIST()
    else:
    ...
    #   a `nn.Dropout` layer with `args.dropout` rate before
    #   each `Linear` layer.
