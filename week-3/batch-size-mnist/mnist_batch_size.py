...
def main(args):
    ...
    # Load data
    mnist = MNIST()
    train_loader = DataLoader(mnist.train, batch_size=..., shuffle=True)
    dev_loader = DataLoader(mnist.dev, batch_size=..., shuffle=False)
    test_loader = DataLoader(mnist.test, batch_size=..., shuffle=False)
