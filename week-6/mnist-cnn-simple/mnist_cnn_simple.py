...
parser.add_argument("--arch", choices=["regular", "lazy"], default="regular", help="Type of initial architecture to use.")
...
def main(args):
    ...
    # TODO: Create a simple convolutional network consisting of:
    # - one 2D convolutional layer with 16 output channels, kernel of size 3, stride of 2, padding of 1;
    # - one 2D convolutional layer with 16 output channels, kernel of size 3, stride of 1, same padding;
    # - one 2D convolutional layer with 24 output channels, kernel of size 3, stride of 2, padding of 1;
    # - one 2D convolutional layer with 24 output channels, kernel of size 3, stride of 1, same padding;
    # - one 2D convolutional layer with 32 output channels, kernel of size 3, stride of 2, padding of 1;
    # - one 2D convolutional layer with 32 output channels, kernel of size 3, stride of 1, same padding;
    # - one flattening layer;
    # - one fully-connected layer with 200 neurons;
    # - one output layer with MNIST.LABELS neurons.
    # Each convolutional layer is with batch normalization and ReLU activation.
    # For regular architecture use `nn.Conv2d` and `nn.Linear` layers, for lazy architecture use `nn.LazyConv2d` and
    # `nn.LazyLinear` layers. For lazy architecture initialize model with passing initial batch through the whole model
    # (in the evaluation mode).

    if args.arch=="regular":
